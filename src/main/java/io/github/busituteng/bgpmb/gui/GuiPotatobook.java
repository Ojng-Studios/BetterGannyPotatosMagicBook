...
package io.github.busituteng.bgpmb.gui;
...
public class GuiPotatobook extends ElementsBgpmbMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiPotatobook(ElementsBgpmbMod instance) {
		super(instance, 3);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				BgpmbMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("bgpmb:textures/potatobook.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("bgpmb:textures/logopng.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 4, this.guiTop + 5, 0, 0, 160, 160, 160, 160);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("You Can Get Coutless Potatos With Potato Magic Circle~", -50, 174, -16777216);
			this.fontRenderer.drawString("(The End)", 59, 193, -16777216);
		}
		...
		protected void actionPerformed(GuiButton button) {
			BgpmbMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
